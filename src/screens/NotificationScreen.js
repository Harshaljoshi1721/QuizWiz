  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        ...
        <Image style={{ width: 25, height: 25 }} source={require('../assets/images/homeiconblack.png')}/>
        </Pressable>
          <Pressable onPress={() => props.navigation.navigate('Notification')}>
          <Image style={{ width: 25, height: 25 }} source={props.isActive ? require('../assets/images/notificationiconblack.png') : require('../assets/images/notificationiconcustom.png')} />
          </Pressable>
